export const En = {
  ...
  Read_more: 'Read more',
  HOW_ACTIONS: 'Our actions',
  Funding_transparency: 'Funding transparency',
  Our_history: 'Our history',
  Our_partners: 'Our partners',
  Health_aid: 'Health aid',
  Humanitarian_emergencies: 'Humanitarian emergencies',
  GET_INVOLVED: 'Get involved',
  Confidentiality: 'Confidentiality',
  Terms_of_use: 'Terms of use',
  Accessibility: 'Accessibility',
  CONTACT_EMERGENCY: 'Contact & Emergency',
  Need_help_Contact_us_at:'Need help? Contact us at :',
  All_rights_reserved : 'COSAMED asbl — All rights reserved | An NGO committed to public health and human dignity',
...
export const FR = {
  ...
  Humanitarian_emergencies: 'Urgences humanitaires',
  Health_aid: 'Aide sanitaire',
  ...
  Need_help_Contact_us_at:'Besoin d’aide ? Contactez-nous à :',
  All_rights_reserved : 'COSAMED asbl — Tous droits réservés | Une ONG engagée pour la santé publique et la dignité humaine',
  All: 'Tout',
  Your_privacy:
  ...
  Funding_transparency: 'Transparence des financements',

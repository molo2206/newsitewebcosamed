export const En = {
	Home: 'Home',
	Your_privacy:"Your privacy is important to us By clicking the 'Accept' button, you consent to the use of 1st and third-party cookies (or similar) to improve your web experience, measure our audience and collect data.",
	...
	Politic_clic: "By clicking Continue, you agree to our privacy policy. You may receive SMS or email notifications from us.",
	...
	We_believe_in_management: "We believe in transparent management of our finances to maintain the trust of our partners and beneficiaries. Here is an overview of our income, expenses, and surplus for the last few years.",
...
export const FR = {
	Home: 'Accueil',
	Your_privacy:"Votre vie privée est importante pour nous En cliquant sur le bouton 'Accepter', vous consentez à l'utilisation du 1er et cookies tiers (ou similaires) pour améliorer votre expérience Web, mesurer notre audience et collecter des données.",
	...
	complete_info: "COMPLÉTER LES INFORMATIONS CI-DESSOUS SI VOUS DÉSIREZ DEVENIR MEMBRE DE COSAMED",
	...
	We_believe_in_management: "Nous croyons en une gestion transparente de nos finances afin de maintenir la confiance de nos partenaires et bénéficiaires. Voici un aperçu de nos revenus, dépenses et excédents des dernières années.",
	Funder: "Bailleur",
	Year: "Année",
	Discover_all_our: "Découvrez tous nos projets en cours, complétés, ou planifiés.",
	Subscribe_to_receive: "Inscrivez-vous pour recevoir les dernières offres d'emploi directemen dans votre boîte mail.",

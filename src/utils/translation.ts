export const En = {
  ...
  To_clic_politic:
    "You may receive text or email notifications from us by clicking here!.",
  The_gift_and_you: "The gift and you",
  Financial_transparency: "Financial transparency",
  Find_out_how_we_use:
    "Learn how we use our resources to make a positive impact.",
  Financial_Report: "Financial Report",
  Our_achievements: "Our achievements",
  Year: "Année",
  Funder: "Funder",
  Discover_all_our:
    "Discover all our projects in progress, completed, or planned.",
  Subscribe_to_receive:
    "Sign up to receive the latest job offers directly in your inbox.",
...
export const FR = {
  ...
  Year: "Année",
  Discover_all_our:
    "Découvrez tous nos projets en cours, complétés, ou planifiés.",
  Subscribe_to_receive:

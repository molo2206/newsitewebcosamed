...
const CardSearchOffre = ({ job }: props) => {
  const { t } = useTranslation();
  return (
    <>
      <div
        key={job.id}
        className="bg-white border dark:bg-slate-800 p-4 rounded-lg shadow-md hover:shadow-lg transition-shadow duration-300"
      >
...
export default CardSearchOffre;

      ...
      <div className="block">
        ...
        {type === "select" ? (
          <select
            ...
            onChange={onChange}
            onFocus={onFocus}
            className="w-full bg-transparent text-[12px] dark:bg-slate-900 rounded-md text-slate-900 border py-3 px-4 dark:text-white border-slate-300 dark:border-slate-700 focus:outline-none focus:border-principal focus:dark:border-principal focus:ring-0"
          >
          ...
          <input
            ...
            accept=".pdf" 
            type="file"
            className="w-full bg-transparent text-[12px] rounded-lg text-slate-800 border py-3 px-4 dark:text-white dark:bg-slate-900 border-slate-300 dark:border-slate-700 

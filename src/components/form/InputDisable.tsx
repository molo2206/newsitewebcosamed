      ...
      <div className="block">
        ...
        {type === "select" ? (
          ...
          <input
            ...
            autoComplete="off"
            type={type || "text"}
            className="w-full bg-transparent hidden  rounded-md text-slate-800 border py-3 px-4 dark:text-white dark:bg-slate-900 border-slate-400 dark:border-slate-700 focus:outline-none focus:border-principal focus:dark:border-principal focus:ring-0"

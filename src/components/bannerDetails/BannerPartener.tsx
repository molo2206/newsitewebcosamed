...
function BannerPartener() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900 mt-10 px-5">
      <div className="max-w-6xl mx-auto">
        <header className="text-center mb-10">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white">
            {t("Partnerships")}
          </h1>
          <p className="text-gray-600 mt-2 text-xl dark:text-white">{t("Data_how_collaborate")}</p>
        </header>
        ...
        {/* Section Contact */}
        <section className="mt-8 text-center dark:bg-slate-900">

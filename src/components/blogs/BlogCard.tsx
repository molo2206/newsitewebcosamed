  ...
  return (
    ...
    >
      ...
      {category && (
        <div className="mt-2">
          <span
            className="text-[10px] font-semibold uppercase text-principal bg-principal/10 px-2 py-1 rounded-md tracking-wide"
      ...
      {/* Titre */}
      <h3
        className="font-semibold text-sm text-gray-800 dark:text-gray-200 mt-2 line-clamp-2"
      ...
      {/* Lire plus */}
      <div className="mt-3 text-sm text-principal font-medium hover:underline">
        {t("Read_more")}
      </div>
    </motion.article>
  );

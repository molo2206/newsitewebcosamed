      ...
      <div className="flex flex-col lg:flex-row items-center lg:items-start justify-between gap-6 lg:gap-4">
        ...
        <div className="w-full lg:w-1/3 flex justify-center lg:justify-end items-center gap-4">
          <button
            ...
            className="hidden sm:inline-block bg-red-500 text-white text-[12px] font-semibold px-4 py-2 rounded-md"
          >
            {t("Donate")}
          </button>
          <span
            onClick={() => navigate("/aboutmedia")}
            className="hidden sm:inline-block text-gray-700 dark:text-white text-[12px] cursor-pointer hover:text-hover"
          >
            {t("Media_resources")}
          </span>
        </div>

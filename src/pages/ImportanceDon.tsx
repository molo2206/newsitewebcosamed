        ...
        <div className="p-6 dark:bg-slate-900 w-full dark:text-white ">
          <div>
            ...
            <section className="mb-10 ">
              ...
              <h1 className=" mb-8 py-2 pl-2 text-center text-2xl font-bold">
                Découvrez l'impact de votre générosité et comment vos
                contributions changent des vies.
              </h1>
              <section className="bg-white p-6 shadow-md dark:border-slate-50  border dark:bg-slate-900 w-full dark:text-white">
              ...
              {/* Section 2 */}
              <section className="bg-white p-6  shadow-md mt-2 dark:border-slate-50  border dark:bg-slate-900  w-full dark:text-white">
                <h2 className="text-2xl font-semibold text-gray-800 dark:text-white">

...
const JobApplicationForm_Data = () => {
    ...
    switch (currentStep) {
      ...
      case 3:
        ...
        if (!inputs.cover_letter) {
          hanldeError("Une lettre de motivation est requise", "cover_letter");
          isValid = false;
        } else {
        ...
        if (!inputs.cv) {
          hanldeError("Un CV est obligatoire", "cv");
          isValid = false;
        } else {
          const MAX_FILE_SIZE = 5120; // 5MB
        ...
        if (!inputs.carte) {
          hanldeError(
            "Le fichier de la carte d'identité est obligatoire",
            "carte"
          );
          isValid = false;
        } else {
        ...
        if (!inputs.dossier) {
          hanldeError("Un Dossier est requis", "dossier");
          isValid = false;
        } else {
          const MAX_FILE_SIZE = 5120; // 5MB
  ...
  return (
    <div className="p-6 dark:bg-slate-900 w-full dark:text-white  bg-gray-100">
      ...
      <header className="bmb-8 bg-principal dark:bg-slate-800 text-white text-center rounded-md p-6 shadow-md">
          ...
          {currentStep === 3 && (
            <div>
              ...
              <div className="">
                ...
                <p className="py-2 line-coverage text-[13px]">
        ...
        <div className="flex justify-between p-2">
          {currentStep > 1 && (
            <button
              type="button"
              onClick={prevStep}
              className="px-2 py-2 text-[12px] bg-gray-200 text-gray-700 rounded-md hover:bg-gray-300"
            >
              Précédent
            </button>
          )}
          {currentStep < totalSteps && (
            <button
              type="button"
              onClick={nextStep}
              className="px-2 py-2 text-[12px] bg-principal text-white rounded-md hover:bg-hover"
            >
              Suivant
            </button>
          )}

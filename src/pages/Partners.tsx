      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-gray-600 mb-6 text-[12px] dark:text-white">
            Si vous souhaitez devenir partenaire de notre organisation et rejoindre
            notre réseau d'excellence, contactez-nous dès aujourd'hui.
          </p>
          <motion.button
            onClick={goToContact}

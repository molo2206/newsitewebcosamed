...
const Carriere = () => {
  ...
  return (
    <div>
      ...
      >
        <h1 className="text-white bg-principal text-4xl font-bold drop-shadow-lg">
      ...
      <section className="bg-principal dark:bg-slate-800 text-white text-center py-16 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mt-8">
            <button
              onClick={goToAbout}
              className="bg-white text-principal dark:bg-slate-800 border dark:border-slate-700 px-6 py-3 font-semibold rounded-md hover:bg-gray-200 transition"
            >
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
        ...
        <div className="text-center">
          ...
          <h3 className="text-lg font-bold text-gray-800 mb-2 dark:text-white">
        ...
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-white">
            Nous fournissons des outils d'apprentissage à nos employés pour leur
            permettre de développer leur carrière en permanence.
          </p>
        </div>
